...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["generated_at"], name="idx_dbs_cache_generated"
                    ),
                ],
                "constraints": [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fingerprint",
                    models.CharField(
                        blank=True, db_index=True, max_length=24, null=True
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["schemaID", "property"], name="idx_schema_prop_schema_prop"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["sample", "analysis_date"], name="idx_sv_sample_analysis"
            ),
        ),
        migrations.AddIndex(
            model_name="samplevariant",
            index=models.Index(
                fields=["variant", "analysis_date"], name="idx_sv_variant_analysis"
            ),
        ),
        migrations.AddConstraint(
            model_name="samplevariant",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["locus_name", "locus_id"], name="idx_va_locus_name_id"
            ),
        ),
        migrations.AddIndex(
            model_name="variantannotation",
            index=models.Index(
                fields=["gene_region", "effect"], name="idx_va_region_effect"
            ),
        ),
        migrations.AddConstraint(
            model_name="variantannotation",
