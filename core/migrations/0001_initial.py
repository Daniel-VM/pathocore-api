    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schema_app_name', models.CharField(blank=True, max_length=40, null=True)),
                ('generated_at', models.DateTimeField(auto_now_add=True, null=True)),
        ...
        migrations.AddField(
            ...
            name='database_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.publicdatabasetype'),
        ),
        migrations.AddField(
            model_name='publicdatabasefields',
            name='schemaID',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='metadata_groups', to='core.schemaproperties')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['sample', 'schema_property'], name='core_metada_sample__83c2cc_idx'), models.Index(fields=['group', 'schema_property'], name='core_metada_group_i_bc41e7_idx')],
            },
        ),
